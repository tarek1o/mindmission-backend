...
exports.OnlineUserRepository = void 0;
const inversify_1 = require("inversify");
const db_1 = __importDefault(require("../../domain/db"));
let OnlineUserRepository = class OnlineUserRepository {
    constructor() { }
    aggregate(args) {
        return db_1.default.onlineUser.aggregate(args);
    }
    count(args) {
        return db_1.default.onlineUser.count(args);
    }
    findMany(args) {
        return db_1.default.onlineUser.findMany(args);
    }
    findUnique(args) {
...
exports.OnlineUserRepository = OnlineUserRepository = __decorate([
    (0, inversify_1.injectable)()
], OnlineUserRepository);
//# sourceMappingURL=OnlineUserRepository.js.map