...
let PaymentRepository = class PaymentRepository {
    constructor() { }
    count(args) {
        return db_1.default.payment.count(args);
    }
    findMany(args) {
        return db_1.default.payment.findMany(args);
    }
    findUnique(args) {
        return db_1.default.payment.findUnique(args);
    }
    create(args) {
        return db_1.default.payment.create(args);
    }
    update(args) {
        return db_1.default.payment.update(args);
    }
    delete(id) {
