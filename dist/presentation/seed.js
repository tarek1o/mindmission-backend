                ...
                lessons: [
                    {
                        ...
                        isFree: true,
                        attachment: '',
                        lessonType: client_1.LessonType.VIDEO,
                        video: {
                    ...
                    },
                    {
                        ...
                        isFree: true,
                        attachment: '',
                        lessonType: client_1.LessonType.ARTICLE,
                        article: {
                    ...
                    },
                    {
                        ...
                        isFree: true,
                        attachment: '',
                        lessonType: client_1.LessonType.QUIZ,
                        quiz: {
                            ...
                            questions: [
                                {
                                    ...
                                    choiceC: 'C',
                                    choiceD: 'D',
                                    correctAnswer: client_1.CorrectAnswer.choiceA,
                                    level: client_1.QuestionLevel.EAZY
                                },
                                {
                                    ...
                                    choiceC: 'C',
                                    choiceD: 'D',
                                    correctAnswer: client_1.CorrectAnswer.choiceB,
                                    level: client_1.QuestionLevel.MEDIUM
                                },
                                {
                                    ...
                                    choiceC: 'C',
                                    choiceD: 'D',
                                    correctAnswer: client_1.CorrectAnswer.choiceC,
                                    level: client_1.QuestionLevel.HARD
                                },
                                {
                                    ...
                                    choiceC: 'C',
                                    choiceD: 'D',
                                    correctAnswer: client_1.CorrectAnswer.choiceD,
                                    level: client_1.QuestionLevel.ADVANCED
                                },
                            ]
                        }
                    },
...
const seeding = async () => {
    try {
        await db_1.default.category.create({
            data: {
                name: 'Programming',
                slug: 'programming',
                type: 'CATEGORY',
                            ...
                            create: {
                                ...
                                courses: {
                                    create: courses.map((course) => {
                                        ...
                                        return {
                                            title,
                                            slug: (0, slugify_1.default)(title, { trim: true, lower: true }),
                                            shortDescription,
                                            description,
                                            courseTeachings,
                                            imageCover,
                                                        ...
                                                        lessons: {
                                                            create: lessons.map((lesson, index) => {
                                                                ...
                                                                return {
                                                                    ...
                                                                    lessonType,
                                                                    order: index + 1,
                                                                    time: (article === null || article === void 0 ? void 0 : article.time) || (video === null || video === void 0 ? void 0 : video.time) || (quiz === null || quiz === void 0 ? void 0 : quiz.time) || 0,
                                                                    ...
                                                                    video: lessonType === 'VIDEO' ? {
                                                                        create: {
                                                                            ...
                                                                            url: video === null || video === void 0 ? void 0 : video.url,
                                                                            time: video.time,
                                                                        }
                                                                    } : undefined,
