...
let StudentController = class StudentController {
    constructor(studentService, paymentService) {
        this.studentService = studentService;
        this.paymentService = paymentService;
        this.getAllStudents = (0, express_async_handler_1.default)(async (request, response, next) => {
            ...
            response.status(HTTPStatusCode_1.default.OK).json(ResponseFormatter_1.ResponseFormatter.formate(true, 'All students are retrieved successfully', promiseResult[0], promiseResult[1], findOptions.skip, findOptions.take));
        });
        this.getStudentById = (0, express_async_handler_1.default)(async (request, response, next) => {
            ...
            response.status(HTTPStatusCode_1.default.OK).json(ResponseFormatter_1.ResponseFormatter.formate(true, 'The student is retrieved successfully', [student]));
        });
        this.addToWishlist = (0, express_async_handler_1.default)(async (request, response, next) => {
            var _a;
            const { select, include } = RequestManager_1.RequestManager.findOptionsWrapper(request);
            ...
            response.status(HTTPStatusCode_1.default.OK).json(ResponseFormatter_1.ResponseFormatter.formate(true, 'The course is added to student wishlist successfully', [updatedStudent]));
        });
        this.removeFromWishlist = (0, express_async_handler_1.default)(async (request, response, next) => {
            var _a;
            const { select, include } = RequestManager_1.RequestManager.findOptionsWrapper(request);
            const { courseId } = request.body.input;
            const updatedStudent = await this.studentService.update({
        ...
        this.enroll = (0, express_async_handler_1.default)(async (request, response, next) => {
            var _a;
            const { select, include } = RequestManager_1.RequestManager.findOptionsWrapper(request);
        ...
        this.enrollmentPayMobConfirmation = (0, express_async_handler_1.default)(async (request, response, next) => {
        ...
        this.enrollmentPayPalConfirmation = (0, express_async_handler_1.default)(async (request, response, next) => {
        ...
        this.rate = (0, express_async_handler_1.default)(async (request, response, next) => {
            var _a;
            const { select, include } = RequestManager_1.RequestManager.findOptionsWrapper(request);
            const updatedStudent = await this.studentService.update({ data: { id: (_a = request.user) === null || _a === void 0 ? void 0 : _a.id, ratings: Object.assign({}, request.body.input) }, select, include });
    ...
    async enrollmentConfirmation(paymentId) {
        var _a;
...
exports.StudentController = StudentController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)('IStudentService')),
    __param(1, (0, inversify_1.inject)("IPaymentService"))
], StudentController);
