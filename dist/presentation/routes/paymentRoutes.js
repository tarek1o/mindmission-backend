...
const { getAllPayments, getPaymentById, pay, payMobPaymentConfirmation, payPalPaymentConfirmation, deletePayment } = DI_1.default.get('PaymentController');
...
paymentRouter.route("/pay")
    .post(isAuthenticated, isAuthorized('Payment', 'POST'), paymentValidator_1.payValidation, pay);
