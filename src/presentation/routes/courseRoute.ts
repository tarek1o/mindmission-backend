...
import {addCourseValidation} from "../middlewares/express-validator/courseValidator"
...
CourseRouter.route("/delete/:id")
	.delete(idValidation, isAuthenticated, isAuthorized('Course', 'DELETE'), deleteCourse);
